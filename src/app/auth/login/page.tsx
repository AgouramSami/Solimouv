        ...
        {!sent ? (
          <>
            ...
            <p className="mt-2 text-sm text-gray-500">
              Créez votre compte ou connectez-vous en 1 clic.
            </p>
            ...
            <button
              ...
              className="mt-6 flex w-full items-center justify-center gap-3 rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-sm transition hover:bg-gray-50 disabled:opacity-60"
            >
              {oauthLoading ? (
